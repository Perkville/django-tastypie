...
class ReadOnlyRelatedNoteResource(ModelResource):
    author = fields.ToOneField(UserResource, 'author', readonly_post=True)
    my_property = fields.CharField(attribute='my_property', null=True, readonly_post=True)
...
class ModelResourceTestCase(TestCase):
    ...
    def test_fields(self):
        ...
        self.assertEqual(annr.fields['content'].readonly_post, False)
        ...
        self.assertEqual(annr.fields['created'].readonly_post, False)
        ...
        self.assertEqual(annr.fields['id'].readonly_post, False)
        ...
        self.assertEqual(annr.fields['is_active'].readonly_post, False)
        ...
        self.assertEqual(annr.fields['resource_uri'].readonly_post, True)
        ...
        self.assertEqual(annr.fields['slug'].readonly_post, False)
        ...
        self.assertEqual(annr.fields['title'].readonly_post, False)
        ...
        self.assertEqual(annr.fields['updated'].readonly_post, False)
