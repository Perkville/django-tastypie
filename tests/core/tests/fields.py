...
class ApiFieldTestCase(TestCase):
    ...
    def test_init(self):
        ...
        field_2 = ApiField(attribute='foo', default=True, null=True, readonly_post=True, help_text='Foo.', use_in="foo")
        ...
        self.assertEqual(field_2.readonly_post, True)
    ...
    def test_hydrate(self):
        ...
        # The readonly case.
        field_5 = ApiField(readonly_post=True)
...
class ToOneFieldTestCase(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(field_1.readonly_post, False)
        ...
        self.assertEqual(field_2.readonly_post, False)
        ...
        self.assertEqual(field_3.readonly_post, False)
        self.assertEqual(field_3.help_text, 'Points to a User.')

        field_4 = ToOneField(UserResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.")
        ...
        self.assertEqual(field_4.readonly_post, True)
        self.assertEqual(field_4.help_text, 'Points to a User.')

        field_5 = ToOneField(UserResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in="list")
        self.assertEqual(field_5.use_in, 'list')

        field_6 = ToOneField(UserResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in="detail")
        self.assertEqual(field_6.use_in, 'detail')

        def use_in_callable(x):
            return True
        field_7 = ToOneField(UserResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in=use_in_callable)
        self.assertTrue(field_7.use_in is use_in_callable)

        field_8 = ToOneField(UserResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in="foo")
    ...
    def test_hydrate(self):
        ...
        # The readonly case.
        field_12 = ToOneField(UserResource, 'author', readonly_post=True)
...
class ToManyFieldTestCase(TestCase):
    ...
    def test_init(self):
        ...
        field_4 = ToManyField(SubjectResource, 'subjects', default=1, null=True, readonly_post=True, help_text='Points to many Subjects.')
        self.assertEqual(field_4.instance_name, None)
        ...
        field_5 = ToManyField(SubjectResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in="list")
        self.assertEqual(field_5.use_in, 'list')

        field_6 = ToManyField(SubjectResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in="detail")
        self.assertEqual(field_6.use_in, 'detail')

        def use_in_callable(x):
            return True
        field_7 = ToManyField(SubjectResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in=use_in_callable)
        self.assertTrue(field_7.use_in is use_in_callable)

        field_8 = ToManyField(SubjectResource, 'author', default=1, null=True, readonly_post=True, help_text="Points to a User.", use_in="foo")
        self.assertEqual(field_8.use_in, 'all')
    ...
    def test_hydrate(self):
        ...
        # The readonly case.
        field_9 = ToManyField(SubjectResource, 'subjects', readonly_post=True)
        field_9.instance_name = 'm2m'
