...
class ApiField(object):
    ...
    def __init__(self, attribute=None, default=NOT_PROVIDED, null=False, blank=False,
                 readonly_post=True, readonly_patch=True, unique=False, help_text=None, use_in='all',
                 verbose_name=None):
        """
...
class RelatedField(ApiField):
    ...
    def __init__(self, to, attribute, related_name=None, default=NOT_PROVIDED, null=False, blank=False,
                 ...
                 full=False, unique=False, help_text=None, use_in='all', verbose_name=None, full_list=True, full_detail=True):
        """
        ...
        being ``True``. Defaults to ``True``.
        """
        super(RelatedField, self).__init__(attribute=attribute, default=default, null=null, blank=blank, readonly_post=readonly_post, readonly_patch=readonly_patch, unique=unique, help_text=help_text, use_in=use_in, verbose_name=verbose_name)
...
class ToOneField(RelatedField):
    ...
    def contribute_to_class(self, cls, name):
        ...
        if not self.related_name:
            if isinstance(self.attribute, string_types):
